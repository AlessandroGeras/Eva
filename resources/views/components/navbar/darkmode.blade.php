...
<div class="inline-block w-full bg-gray-200 pb-2 dark:bg-black">
    ...
    <label for="darkmode_toggle" id="geras" class="w-20 h-9 relative block mx-auto bg-gray-300 cursor-pointer rounded-[35px] shadow after:content-[''] after:w-8 after:h-8 after:absolute after:top-[2px] after:left-1 after:gradient after:rounded-[30px] after:shadow-[0_5px_10px_-15px_rgba(0,0,0,0.2)] active:after:w-20">
