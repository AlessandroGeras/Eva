...
<div id="form_criar_palestras" class="hidden">
    <form action="/create-lecture" method="POST" enctype="multipart/form-data" onsubmit="if((document.getElementById('form_criar_palestras_date').value)>=('<?php echo date('Y-m-d\TH:i') ?>')){loading('Criando palestra');}">
        @csrf
